...
public class BufferedSourceTest {
  ...
  @Test public void readShortSplitAcrossMultipleSegments() throws Exception {
    sink.writeUtf8(TestUtil.repeat('a', Segment.SIZE - 1));
    sink.write(new byte[] { (byte) 0xab, (byte) 0xcd });
  ...
  @Test public void readIntSplitAcrossMultipleSegments() throws Exception {
    sink.writeUtf8(TestUtil.repeat('a', Segment.SIZE - 3));
    sink.write(new byte[] {
        (byte) 0xab, (byte) 0xcd, (byte) 0xef, (byte) 0x01
    });
  ...
  @Test public void readLongSplitAcrossMultipleSegments() throws Exception {
    sink.writeUtf8(TestUtil.repeat('a', Segment.SIZE - 7));
    sink.write(new byte[] {
        (byte) 0xab, (byte) 0xcd, (byte) 0xef, (byte) 0x01, (byte) 0x87, (byte) 0x65, (byte) 0x43,
        (byte) 0x21,
    });
  ...
  @Test public void readFully() throws Exception {
    ...
    assertEquals(TestUtil.repeat('a', 9999), sink.readUtf8());
  ...
  @Test public void readFullyByteArray() throws IOException {
    ...
    data.writeUtf8("Hello").writeUtf8(TestUtil.repeat('e', Segment.SIZE));
  ...
  @Test public void readByteArray() throws IOException {
    String string = "abcd" + TestUtil.repeat('e', Segment.SIZE);
    sink.writeUtf8(string);
    TestUtil.assertByteArraysEquals(string.getBytes(UTF_8), source.readByteArray());
  }
  ...
  @Test public void readByteString() throws IOException {
    sink.writeUtf8("abcd").writeUtf8(TestUtil.repeat('e', Segment.SIZE));
    assertEquals("abcd" + TestUtil.repeat('e', Segment.SIZE), source.readByteString().utf8());
  }
  ...
  @Test public void readUtf8SpansSegments() throws Exception {
    sink.writeUtf8(TestUtil.repeat('a', Segment.SIZE * 2));
    source.skip(Segment.SIZE - 1);
    assertEquals("aa", source.readUtf8(2));
  }

  @Test public void readUtf8Segment() throws Exception {
    sink.writeUtf8(TestUtil.repeat('a', Segment.SIZE));
    assertEquals(TestUtil.repeat('a', Segment.SIZE), source.readUtf8(Segment.SIZE));
  }

  @Test public void readUtf8PartialBuffer() throws Exception {
    sink.writeUtf8(TestUtil.repeat('a', Segment.SIZE + 20));
    assertEquals(TestUtil.repeat('a', Segment.SIZE + 10), source.readUtf8(Segment.SIZE + 10));
  }

  @Test public void readUtf8EntireBuffer() throws Exception {
    sink.writeUtf8(TestUtil.repeat('a', Segment.SIZE * 2));
    assertEquals(TestUtil.repeat('a', Segment.SIZE * 2), source.readUtf8());
  }

  @Test public void skip() throws Exception {
    sink.writeUtf8("a");
    sink.writeUtf8(TestUtil.repeat('b', Segment.SIZE));
    sink.writeUtf8("c");
    source.skip(1);
  ...
  @Test public void indexOf() throws Exception {
    ...
    sink.writeUtf8(TestUtil.repeat('b', Segment.SIZE - 2)); // ab...b
    assertEquals(0, source.indexOf((byte) 'a'));
    assertEquals(1, source.indexOf((byte) 'b'));
  ...
  @Test public void indexOfWithOffset() throws IOException {
    sink.writeUtf8("a").writeUtf8(TestUtil.repeat('b', Segment.SIZE)).writeUtf8("c");
  ...
  @Test public void longHexStringAcrossSegment() throws IOException {
    sink.writeUtf8(TestUtil.repeat('a', Segment.SIZE - 8)).writeUtf8("FFFFFFFFFFFFFFFF");
  ...
  @Test public void longDecimalStringAcrossSegment() throws IOException {
    sink.writeUtf8(TestUtil.repeat('a', Segment.SIZE - 8)).writeUtf8("1234567890123456");
    sink.writeUtf8("zzz");
    source.skip(Segment.SIZE - 8);
