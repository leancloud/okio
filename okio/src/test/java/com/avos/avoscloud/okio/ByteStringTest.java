...
import static com.avos.avoscloud.okio.TestUtil.assertEquivalent;
...
public class ByteStringTest {
  ...
  @Test public void utf8() throws Exception {
    ...
    TestUtil.assertByteArraysEquals(byteString.toByteArray(), bronzeHorseman.getBytes(Util.UTF_8));
  ...
  @Test public void write() throws Exception {
    ...
    TestUtil.assertByteArraysEquals(new byte[]{0x61, 0x62, 0x63}, out.toByteArray());
  }
